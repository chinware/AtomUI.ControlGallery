...
public partial class BoxPanelShowCase : ReactiveUserControl<BoxPanelShowCaseViewModel>
{
    ...
    {
        if (e.Source is Button button && button.Text == "add a space of size 40")
        {
            ChangeSpaceBoxPanel.AddSpacing(40);
            AddSpaceButton.Text = "remove the space of size 40";
        }
        else
        {
            ChangeSpaceBoxPanel.Children.Remove(ChangeSpaceBoxPanel.Children[4]);
            AddSpaceButton.Text = "add a space of size 40";
        }
    }
    ...
    {
        if (e.Source is Button button && button.Text == "add a placeholder flex")
        {
            AddPlaceholderBoxPanel.AddFlex(1);
            AddFlexButton.Text = "remove the placeholder flex";
        }
        else
        {
            AddPlaceholderBoxPanel.Children.Remove(AddPlaceholderBoxPanel.Children[2]);
            AddFlexButton.Text = "add a placeholder flex";
        }
    }
}